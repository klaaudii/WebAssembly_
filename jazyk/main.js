...
export function runWasm(wasmBinary) {
    ...
    WebAssembly.instantiate(wasmBytes, importObject)
        ...
        //     }
            ...
            // mem_i32[5] = size;
            // for (let i = 5 + 1; i < 5 + size + 1; i++) {
            //     mem_f32[i] = 10//Math. floor(Math. random() * (250 - -250 + 1)) -250;
            //
            // }
            // console.log(mem_f32[6])
            // mem_f32[5 + size + 1] = size;
            // for (let i = 5 + size + 2; i < 5 + 2*size +2; i++) {
            //     mem_f32[i] = 11//Math. floor(Math. random() * (250 - -250 + 1)) -250;
            // }
            // let canvas = document.createElement("canvas")
            // let div = document.createElement("div")
            //
            ...
            // ctx.fillRect(0, 0, canvas.width, canvas.height);
            // ctx.fillStyle = 'black'; // Light gray
            // for (let i = 5; i < 5+size; i+= 2) {
            //     ctx.beginPath();
            //     ctx.moveTo(250,250);  // Start point
            //     ctx.lineTo(mem_f32[i]+250, mem_f32[i+1]+250);  // End point
            //     ctx.stroke();
            // }
            //
            //
            ...
            //     arr.push(mem_f32[i]);
            // }
            // for (let i = 5+1 + size; i < 5+2*size + 1; i++) {
            //     perturbation.push(mem_f32[i]);
            // }
            ...
            //
            // console.time('doSomething')
            //  // exports.addv(3,83,0,1082130432)
            //  exports.f(83, 83)
            //
            // // ((new Uint32Array(new Float32Array([4*(5 + size + 1)]).buffer)[0] & -2) << 2) | 3
            // // 16099
            //
            // // setTimeout((()=> exports.add2(83,  83)), 5000)
            ...
            //     (export f)
            // let size = 10000
            // let freeMemIndex = exports.freeMemIndex.value / 4;
            //
            ...
            //     (define (add sum i l)
            //
            // (if (= i 10) sum  (add (+v sum (list-ref l i)) (+ i 1) l)    ))
            //
            //
            // (define (f l)
            // (let* ((sum (vector 0 0 0 0)))  (add sum 0 l)  ))
            //
            //
            // (export f)
            ...
            // let base = freeMemIndex*4*2;
            // let size = 10000;
            // let counter = 0;
            // while (counter !== size) {
            //     mem_i32[freeMemIndex] = 115+112*counter;
            //     mem_i32[freeMemIndex+1] = counter === size - 1 ? -1 : 48+28*counter;
            //     mem_i32[freeMemIndex+2] = 4;
            //     mem_f32[freeMemIndex+3] = 1;
            //     mem_f32[freeMemIndex+4] = 1;
            //     mem_f32[freeMemIndex+5] = 1;
            //     mem_f32[freeMemIndex+6] = 1;
            //     freeMemIndex += 7;
            //     counter++;
            // }
            // console.time('doSomething')
            ...
            //     console.time('doSomethingJss')
            //     for (let i = 0; i < imgData.length; i++) {
            //         if (i % 4 === 3) continue //imgData[i] = 255
            //         else if (imgData[i] > 150) imgData[i] = 255
            //         else imgData[i] = 0
            //     }
            //     console.timeEnd('doSomethingJss')
            //     // for (var i = 0; i < data.length; i += 4) {
            //     //     // Increase blue channel, reduce red and green channels
            //     //     data[i] = data[i] *0.5; // Red channel
            //     //     data[i + 1] = data[i + 1] ; // Green channel
            //     //     data[i + 2] = data[i + 2] + 255; // Blue channel (boosted)
            //     // }
            //     ctx.putImageData(new ImageData( new Uint8ClampedArray(imgData, 0,
            //         canvas.width*canvas.height*4), canvas.width, canvas.height), 0,0);
            // }
            ...
            // if (error.constructor !== SchemeError)
